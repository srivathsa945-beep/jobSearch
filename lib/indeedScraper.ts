...
export async function searchIndeedJobs(
  ...
  console.log('⚠️ Indeed scraper: Actors not available. Skipping Indeed search.')
  console.log('   To enable Indeed search, find a working Indeed scraper actor in Apify store')
  return []
}
